...
var _FCIMFAY4cjs = require('./FCIMFAY4.cjs');


var _HOAOCMNXcjs = require('./HOAOCMNX.cjs');


var _ERZLFUVIcjs = require('./ERZLFUVI.cjs');
...
function createDialogStore(props = {}) {
  return _NQHLCEXFcjs.createDisclosureStore.call(void 0, props);
}

// ../ariakit-react-components/dist/dialog/dialog-store.js
function useDialogStoreProps(store, update, props) {
  return _NQHLCEXFcjs.useDisclosureStoreProps.call(void 0, store, update, props);
}
function useDialogStore(props = {}) {
  const [store, update] = _P5CWMRCEcjs.useStore.call(void 0, createDialogStore, props);
...
var TagName = "div";
var useFocusableContainer = _GF35MDH7cjs.createHook.call(void 0, function useFocusableContainer2({ autoFocusOnShow = true, ...props }) {
  props = _GF35MDH7cjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _BJQJHCU2cjs.FocusableContext.Provider, {
    value: autoFocusOnShow,
    children: element
  }), [autoFocusOnShow]);
  return props;
});
var FocusableContainer = _GF35MDH7cjs.forwardRef.call(void 0, function FocusableContainer2(props) {
...
function markElement(element, id = "") {
  return _GF35MDH7cjs.chain.call(void 0, setProperty(element, getPropertyName(), true), setProperty(element, getPropertyName(id), true));
}
function markAncestor(element, id = "") {
  return _GF35MDH7cjs.chain.call(void 0, setProperty(element, getPropertyName("", "ancestor"), true), setProperty(element, getPropertyName(id, "ancestor"), true));
}
function markTreeInside(id, elements) {
  return _GF35MDH7cjs.chain.call(void 0, ...elements.map((element) => {
...
function inSnapshot(id, element) {
  const doc = _GF35MDH7cjs.getDocument.call(void 0, element);
...
function shouldWalkElement(id, element, ignoredElements) {
  ...
  return !ignoredElements.some((enabledElement) => enabledElement && _GF35MDH7cjs.contains.call(void 0, element, enabledElement));
}
...
function createWalkTreeSnapshot(id, elements) {
  const { body } = _GF35MDH7cjs.getDocument.call(void 0, elements[0]);
  const cleanups2 = [];
  ...
  return _GF35MDH7cjs.chain.call(void 0, setProperty(body, getSnapshotPropertyName(id), true), () => {
...
function DialogBackdrop({ store, backdrop, backdropRef, alwaysVisible, hidden }) {
  ...
  const disclosure = _NQHLCEXFcjs.useDisclosureStore.call(void 0, { disclosure: store });
  ...
  const props = _NQHLCEXFcjs.useDisclosureContent.call(void 0, {
    ref: _GF35MDH7cjs.useMergeRefs.call(void 0, ref, backdropRef),
    store: disclosure,
    role: "presentation",
  ...
  if (_react.isValidElement.call(void 0, backdrop)) return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _HOAOCMNXcjs.Role, {
    ...props,
    render: backdrop
  });
  const Component = typeof backdrop !== "boolean" ? backdrop : "div";
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _HOAOCMNXcjs.Role, {
    ...props,
...
function disableTree(element, ignoredElements) {
  if (!("style" in element)) return _GF35MDH7cjs.noop;
  if (supportsInert()) return setProperty(element, "inert", true);
  return _GF35MDH7cjs.chain.call(void 0, ..._GF35MDH7cjs.getAllTabbableIn.call(void 0, element, true).map((element2) => {
    if (ignoredElements == null ? void 0 : ignoredElements.some((el) => el && _GF35MDH7cjs.contains.call(void 0, el, element2))) return _GF35MDH7cjs.noop;
    const restoreFocusMethod = orchestrate(element2, "focus", () => {
      element2.focus = _GF35MDH7cjs.noop;
      return () => {
        delete element2.focus;
      };
    });
    return _GF35MDH7cjs.chain.call(void 0, setAttribute(element2, "tabindex", "-1"), restoreFocusMethod);
...
function addRoleNoneCleanup(cleanups2, ancestor, elements) {
  ...
  if (elements.some((el) => el && _GF35MDH7cjs.contains.call(void 0, el, ancestor))) return;
...
function prependHiddenDismiss(container, onClick) {
  const button = _GF35MDH7cjs.getDocument.call(void 0, container).createElement("button");
  button.type = "button";
  button.tabIndex = -1;
  button.textContent = "Dismiss popup";
  Object.assign(button.style, _ERZLFUVIcjs.getVisuallyHiddenStyle.call(void 0, ));
...
function usePreviousMouseDownRef(enabled, scope) {
  ...
  _react.useEffect.call(void 0, () => {
    ...
    return _GF35MDH7cjs.addGlobalEventListener.call(void 0, "mousedown", onMouseDown, true, scope);
  }, [enabled, scope]);
...
function isInDocument(target) {
  ...
  return _GF35MDH7cjs.contains.call(void 0, _GF35MDH7cjs.getDocument.call(void 0, target).body, target);
}
function isDisclosure(disclosure, target) {
  if (!disclosure) return false;
  if (_GF35MDH7cjs.contains.call(void 0, disclosure, target)) return true;
  const activeId = target.getAttribute("aria-activedescendant");
  if (activeId) {
    const activeElement = _GF35MDH7cjs.getDocument.call(void 0, disclosure).getElementById(activeId);
    if (activeElement) return _GF35MDH7cjs.contains.call(void 0, disclosure, activeElement);
  }
  return false;
}
...
function useEventOutside({ store, type, listener, capture, open, contentElement, focusedRef }) {
  const callListener = _GF35MDH7cjs.useEvent.call(void 0, listener);
  _react.useEffect.call(void 0, () => {
    if (!open) return;
    const onEvent = (event) => {
      ...
      if (!_GF35MDH7cjs.isElement.call(void 0, target)) return;
      if (!isInDocument(target)) return;
      if (_GF35MDH7cjs.contains.call(void 0, contentElement2, target)) return;
    ...
    return _GF35MDH7cjs.addGlobalEventListener.call(void 0, type, onEvent, capture, contentElement ? _GF35MDH7cjs.getWindow.call(void 0, contentElement) : void 0);
  }, [
    open,
    capture,
    store,
...
function useHideOnInteractOutside(store, hideOnInteractOutside, domReady, interactedOutsideRef) {
  ...
  const contentElement = _P5CWMRCEcjs.useStoreState.call(void 0, store, "contentElement");
  const previousMouseDownRef = usePreviousMouseDownRef(open, contentElement ? _GF35MDH7cjs.getWindow.call(void 0, contentElement) : void 0);
  ...
  useEventOutside({
    ...
    listener: (event) => {
      const { contentElement: contentElement2 } = store.getState();
      if (!contentElement2) return;
      if (event.target === _GF35MDH7cjs.getDocument.call(void 0, contentElement2)) return;
      if (!shouldHideOnInteractOutside(hideOnInteractOutside, event)) return;
      store.hide();
    }
  });
...
function useNestedDialogs(store) {
  ...
  const add = _react.useCallback.call(void 0, (dialog) => {
    ...
    return _GF35MDH7cjs.chain.call(void 0, (_a = context.add) == null ? void 0 : _a.call(context, dialog), () => {
      setDialogs((dialogs2) => dialogs2.filter((d) => d !== dialog));
    });
  }, [context]);
  _GF35MDH7cjs.useSafeLayoutEffect.call(void 0, () => {
    return _P5CWMRCEcjs.sync.call(void 0, store, ["open", "contentElement"], (state) => {
      var _a;
...
function useRootDialog({ attribute, contentId, contentElement, enabled }) {
  const [updated, retry] = _GF35MDH7cjs.useForceUpdate.call(void 0, );
  const isRootDialog = _react.useCallback.call(void 0, () => {
    if (!enabled) return false;
    if (!contentElement) return false;
    const { body } = _GF35MDH7cjs.getDocument.call(void 0, contentElement);
...
var isIOS = _GF35MDH7cjs.isApple.call(void 0, ) && !_GF35MDH7cjs.isMac.call(void 0, );
...
function usePreventBodyScroll(contentElement, contentId, enabled) {
  ...
  (isIOS ? _react.useEffect : (0, _GF35MDH7cjs.useSafeLayoutEffect))(() => {
    if (!isRootDialog()) return;
    if (!contentElement) return;
    const doc = _GF35MDH7cjs.getDocument.call(void 0, contentElement);
    const win = _GF35MDH7cjs.getWindow.call(void 0, contentElement);
    ...
    const setStyle = () => {
      ...
      const hideHtmlOverflow = () => _GF35MDH7cjs.chain.call(void 0, setCSSProperty(documentElement, "overflow-x", "hidden"), setCSSProperty(documentElement, "overflow-y", "hidden"));
      const withHiddenHtmlOverflow = (restoreStyle) => {
        if (!htmlScrolls) return restoreStyle;
        return _GF35MDH7cjs.chain.call(void 0, restoreStyle, hideHtmlOverflow());
      };
      if (!hasGutter && !scrollbarWidth) return withHiddenHtmlOverflow(assignStyle(body, { overflow: "hidden" }));
      if (hasGutter || supportsScrollbarGutter(win)) return _GF35MDH7cjs.chain.call(void 0, setCSSProperty(documentElement, "scrollbar-gutter", hasGutter ? scrollbarGutter : "stable"), hideHtmlOverflow());
      return withHiddenHtmlOverflow(_GF35MDH7cjs.chain.call(void 0, setCSSProperty(documentElement, "--scrollbar-width", `${scrollbarWidth}px`), assignStyle(body, {
        overflow: "hidden",
...
var TagName2 = "div";
var isSafariBrowser = _GF35MDH7cjs.isSafari.call(void 0, );
function isAlreadyFocusingAnotherElement(dialog) {
  const activeElement = _GF35MDH7cjs.getActiveElement.call(void 0, dialog);
  if (!activeElement) return false;
  if (dialog && _GF35MDH7cjs.contains.call(void 0, dialog, activeElement)) return false;
  if (_GF35MDH7cjs.isFocusable.call(void 0, activeElement)) return true;
  return false;
}
...
var useDialog = _GF35MDH7cjs.createHook.call(void 0, function useDialog2({ store: storeProp, open: openProp, onClose, focusable = true, modal = true, portal = modal, backdrop = modal, hideOnEscape = true, hideOnInteractOutside = true, getPersistentElements, preventBodyScroll = modal, autoFocusOnShow = true, autoFocusOnHide = true, initialFocus, finalFocus, unmountOnHide, unstable_treeSnapshotKey, ...props }) {
  ...
  const preserveTabOrder = _P5CWMRCEcjs.useStoreState.call(void 0, store, ["mounted"], (state) => preserveTabOrderProp && !modal && state.mounted);
  const id = _GF35MDH7cjs.useId.call(void 0, props.id);
  const open = _P5CWMRCEcjs.useStoreState.call(void 0, store, "open");
  const mounted = _P5CWMRCEcjs.useStoreState.call(void 0, store, "mounted");
  const contentElement = _P5CWMRCEcjs.useStoreState.call(void 0, store, "contentElement");
  const hidden = _NQHLCEXFcjs.isHidden.call(void 0, mounted, props.hidden, props.alwaysVisible);
  usePreventBodyScroll(contentElement, id, preventBodyScroll && !hidden);
  const interactedOutsideRef = _react.useRef.call(void 0, false);
  _GF35MDH7cjs.useSafeLayoutEffect.call(void 0, () => {
    return _P5CWMRCEcjs.sync.call(void 0, store, ["open"], (state) => {
      if (!state.open) return;
  ...
  props = _GF35MDH7cjs.useWrapElement.call(void 0, props, wrapElement, [wrapElement]);
  const lastMousedownRef = _react.useRef.call(void 0, null);
  if (isSafariBrowser) _react.useEffect.call(void 0, () => {
    if (!domReady) return;
    const dialog = ref.current;
    if (!dialog) return;
    const doc = _GF35MDH7cjs.getDocument.call(void 0, dialog);
    const onMousedown = (event) => {
  ...
  _GF35MDH7cjs.useSafeLayoutEffect.call(void 0, () => {
    if (!open) return;
    const dialog = ref.current;
    const activeElement = _GF35MDH7cjs.getActiveElement.call(void 0, dialog, true);
    ...
    if (activeElement.tagName === "BODY") {
      ...
      if (!_GF35MDH7cjs.isFocusable.call(void 0, fallback)) return;
      if (dialog && _GF35MDH7cjs.contains.call(void 0, dialog, fallback)) return;
      store.setDisclosureElement(fallback);
      return;
    }
    if (dialog && _GF35MDH7cjs.contains.call(void 0, dialog, activeElement)) return;
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const dialog = ref.current;
    if (!dialog) return;
    const win = _GF35MDH7cjs.getWindow.call(void 0, dialog);
  ...
  const getPersistentElementsProp = _GF35MDH7cjs.useEvent.call(void 0, getPersistentElements);
  _GF35MDH7cjs.useSafeLayoutEffect.call(void 0, () => {
    if (!id) return;
    if (!canTakeTreeSnapshot) return;
    ...
    if (modal) return _GF35MDH7cjs.chain.call(void 0, restoreInsideMarks, markAndDisableTreeOutside(id, allElements));
    return _GF35MDH7cjs.chain.call(void 0, restoreInsideMarks, markTreeOutside(id, [disclosureElement, ...allElements]));
  }, [
    id,
    store,
    canTakeTreeSnapshot,
  ...
  const autoFocusOnShowProp = _GF35MDH7cjs.useBooleanEvent.call(void 0, autoFocusOnShow);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const element = getElementFromProp(initialFocus, true) || contentElement.querySelector("[data-autofocus=true],[autofocus]") || _GF35MDH7cjs.getFirstTabbableIn.call(void 0, contentElement, true, portal && preserveTabOrder) || contentElement;
    const isElementFocusable = _GF35MDH7cjs.isFocusable.call(void 0, element);
  ...
  const autoFocusOnHideProp = _GF35MDH7cjs.useBooleanEvent.call(void 0, autoFocusOnHide);
  ...
  const focusOnHide = _react.useCallback.call(void 0, (dialog, retry = true) => {
    ...
    if (element && !_GF35MDH7cjs.isFocusable.call(void 0, element)) {
      const maybeParentDialog = element.closest("[data-dialog]");
      if (maybeParentDialog == null ? void 0 : maybeParentDialog.id) {
        const doc = _GF35MDH7cjs.getDocument.call(void 0, maybeParentDialog);
        const selector = `[aria-controls~="${maybeParentDialog.id}"]`;
        const control = doc.querySelector(selector);
        if (control) element = control;
      }
    }
    const isElementFocusable = element && _GF35MDH7cjs.isFocusable.call(void 0, element);
  ...
  const hideOnEscapeProp = _GF35MDH7cjs.useBooleanEvent.call(void 0, hideOnEscape);
  _react.useEffect.call(void 0, () => {
    if (!domReady) return;
    if (!mounted) return;
    const onKeyDown = (event) => {
      ...
      const target = event.target;
      if (!_GF35MDH7cjs.isNode.call(void 0, target)) return;
      const { disclosureElement } = store.getState();
      const isValidTarget = () => {
        if (_GF35MDH7cjs.isElement.call(void 0, target) && target.tagName === "BODY") return true;
        if (_GF35MDH7cjs.contains.call(void 0, dialog, target)) return true;
        if (!disclosureElement) return true;
        if (_GF35MDH7cjs.contains.call(void 0, disclosureElement, target)) return true;
        if (_GF35MDH7cjs.isElement.call(void 0, target) && isElementMarked(target, dialog.id)) return true;
        return false;
      };
    ...
    return _GF35MDH7cjs.addGlobalEventListener.call(void 0, "keydown", onKeyDown, true, contentElement ? _GF35MDH7cjs.getWindow.call(void 0, contentElement) : void 0);
  }, [
    store,
    domReady,
    mounted,
  ...
  props = _GF35MDH7cjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _DWSXHZYMcjs.HeadingLevel, {
  ...
  props = _GF35MDH7cjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _NQHLCEXFcjs.DialogScopedContextProvider, {
    value: store,
    children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _NQHLCEXFcjs.DialogHeadingContext.Provider, {
      value: setHeadingId,
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _NQHLCEXFcjs.DialogDescriptionContext.Provider, {
  ...
  props = _NQHLCEXFcjs.useDisclosureContent.call(void 0, {
    store,
    ...props,
    unstable_otherElementRef: backdropRef
  });
  props = _BJQJHCU2cjs.useFocusable.call(void 0, {
    ...props,
    focusable
  });
  props = _FCIMFAY4cjs.usePortal.call(void 0, {
    portal,
    ...props,
    portalRef,
    preserveTabOrder
...
function createDialogComponent(Component, useProviderContext = _NQHLCEXFcjs.useDialogProviderContext) {
  return _GF35MDH7cjs.forwardRef.call(void 0, function DialogComponent(props) {
    const context = useProviderContext();
    if (!_P5CWMRCEcjs.useStoreState.call(void 0, props.store || context, ["mounted"], (state) => !props.unmountOnHide || (state == null ? void 0 : state.mounted) || !!props.open)) return null;
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Component, { ...props });
  });
}
var DialogWithStore = createDialogComponent(_GF35MDH7cjs.forwardRef.call(void 0, function DialogImpl(props) {
  const htmlProps = useDialog(props);
  return _GF35MDH7cjs.createElement.call(void 0, TagName2, htmlProps);
}), _NQHLCEXFcjs.useDialogProviderContext);
var DialogWithInternalStore = _GF35MDH7cjs.forwardRef.call(void 0, function DialogWithInternalStore2(props) {
...
var Dialog = _GF35MDH7cjs.forwardRef.call(void 0, function Dialog2(props) {
  const context = _NQHLCEXFcjs.useDialogProviderContext.call(void 0, );
