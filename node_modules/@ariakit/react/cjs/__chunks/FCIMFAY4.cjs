...
var _GDSOO4UJcjs = require('./GDSOO4UJ.cjs');
...
function getPortalElement(element, portalElement) {
  if (!portalElement) return _GF35MDH7cjs.getDocument.call(void 0, element).createElement("div");
...
function attachPortalRef(ref, node) {
  return {
    ref,
    node,
    cleanup: _GF35MDH7cjs.setRef.call(void 0, ref, node)
  };
}
function detachPortalRef(attached) {
  if (typeof attached.cleanup === "function") attached.cleanup();
  else _GF35MDH7cjs.setRef.call(void 0, attached.ref, null);
}
var usePortal = _GF35MDH7cjs.createHook.call(void 0, function usePortal2({ preserveTabOrder, preserveTabOrderAnchor, portalElement, portalRef, portal = true, ...props }) {
  const ref = _react.useRef.call(void 0, null);
  const refProp = _GF35MDH7cjs.useMergeRefs.call(void 0, ref, props.ref);
  ...
  const portalRefProp = _GF35MDH7cjs.useLiveRef.call(void 0, portalRef);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const doc = _GF35MDH7cjs.getDocument.call(void 0, portalNode);
  ...
  _GF35MDH7cjs.useSafeLayoutEffect.call(void 0, () => {
    ...
    const element = _GF35MDH7cjs.getDocument.call(void 0, preserveTabOrderAnchor).createElement("span");
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const onFocus = (event) => {
      ...
      if (focusing) return _GF35MDH7cjs.restoreFocusIn.call(void 0, portalNode);
      raf = requestAnimationFrame(() => {
        _GF35MDH7cjs.disableFocusIn.call(void 0, portalNode, true);
      });
    };
  ...
  props = _GF35MDH7cjs.useWrapElement.call(void 0, props, (element) => {
    ...
    element = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
      preserveTabOrder && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _GDSOO4UJcjs.FocusTrap, {
        ref: innerBeforeRef,
        "data-focus-trap": props.id,
        className: "__focus-trap-inner-before",
        onFocus: (event) => {
          if (_GF35MDH7cjs.isFocusEventOutside.call(void 0, event, portalNode)) queueFocus(_GF35MDH7cjs.getNextTabbable.call(void 0, ));
      ...
      preserveTabOrder && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _GDSOO4UJcjs.FocusTrap, {
        ...
        onFocus: (event) => {
          if (_GF35MDH7cjs.isFocusEventOutside.call(void 0, event, portalNode)) queueFocus(_GF35MDH7cjs.getPreviousTabbable.call(void 0, ));
    ...
    let preserveTabOrderElement = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
      preserveTabOrder && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _GDSOO4UJcjs.FocusTrap, {
        ...
        onFocus: (event) => {
          if (!(event.relatedTarget === outerAfterRef.current) && _GF35MDH7cjs.isFocusEventOutside.call(void 0, event, portalNode)) queueFocus(innerBeforeRef.current);
          else queueFocus(_GF35MDH7cjs.getPreviousTabbable.call(void 0, ));
        }
      }),
      ...
      preserveTabOrder && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _GDSOO4UJcjs.FocusTrap, {
        ...
        onFocus: (event) => {
          if (_GF35MDH7cjs.isFocusEventOutside.call(void 0, event, portalNode)) queueFocus(innerAfterRef.current);
          else {
            const nextTabbable = _GF35MDH7cjs.getNextTabbable.call(void 0, );
            if (nextTabbable === innerBeforeRef.current) {
              requestAnimationFrame(() => {
                var _a;
                return (_a = _GF35MDH7cjs.getNextTabbable.call(void 0, )) == null ? void 0 : _a.focus();
              });
              return;
            }
...
var Portal = _GF35MDH7cjs.forwardRef.call(void 0, function Portal2(props) {
