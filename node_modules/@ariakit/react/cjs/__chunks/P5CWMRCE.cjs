...
var require_use_sync_external_store_shim_production = _GF35MDH7cjs.__commonJS.call(void 0, {
  "../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.7/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js"(exports) {
    "use strict";
    var React2 = _GF35MDH7cjs.__require.call(void 0, "react");
    function is(x, y) {
...
var require_use_sync_external_store_shim_development = _GF35MDH7cjs.__commonJS.call(void 0, {
...
var require_shim = _GF35MDH7cjs.__commonJS.call(void 0, {
...
function getInternal(store, key) {
  ...
  _GF35MDH7cjs.invariant.call(void 0, internals, "Invalid store");
...
function getCleanupPrevState(prevState, state, stateBeforeCleanup, updatedKey) {
  ...
  for (const key of _GF35MDH7cjs.getKeys.call(void 0, state)) {
...
function createStore(initialState, ...stores) {
  ...
  const storeInit = () => {
    ...
    const stateKeys = _GF35MDH7cjs.getKeys.call(void 0, state);
    const desyncs = [];
    for (const store of stores) {
      const storeState = (_a = store == null ? void 0 : store.getState) == null ? void 0 : _a.call(store);
      if (!storeState) continue;
      const keys = stateKeys.filter((key) => _GF35MDH7cjs.hasOwnProperty.call(void 0, storeState, key));
    ...
    destroy = _GF35MDH7cjs.chain.call(void 0, ...desyncs, ...teardowns, ...cleanups);
    return maybeDestroy;
  };
  ...
  const storePick = (keys) => createStore(_GF35MDH7cjs.pick.call(void 0, state, keys), finalStore);
  const storeOmit = (keys) => createStore(_GF35MDH7cjs.omit.call(void 0, state, keys), finalStore);
  ...
  const setState = (key, value, fromStores = false) => {
    var _a, _b;
    if (!_GF35MDH7cjs.hasOwnProperty.call(void 0, state, key)) return;
    const currentValue = state[key];
    const nextValue = _GF35MDH7cjs.applyState.call(void 0, value, () => currentValue);
...
function throwOnConflictingProps(props, store) {
  ...
  if (!defaultKeys.filter((key) => _GF35MDH7cjs.hasOwnProperty.call(void 0, storeState, key)).length) return;
...
var import_shim = _GF35MDH7cjs.__toESM.call(void 0, require_shim(), 1);
...
function useStoreState(store, keyOrKeysOrSelector = _GF35MDH7cjs.identity, selector) {
  ...
  const getSnapshot = () => {
    ...
    if (!state) return;
    if (!_GF35MDH7cjs.hasOwnProperty.call(void 0, state, keyOrKeysOrSelector)) return;
...
function useStoreStateObject(store, objectOrKeys, object) {
  ...
  const getSnapshot = () => {
    ...
    for (const prop in stateObject) {
      ...
      const value = state && _GF35MDH7cjs.hasOwnProperty.call(void 0, state, keyOrSelector) ? state[keyOrSelector] : void 0;
...
function useStoreProps(store, props, key, setKey) {
  const value = _GF35MDH7cjs.hasOwnProperty.call(void 0, props, key) ? props[key] : void 0;
  const setValue = setKey ? props[setKey] : void 0;
  const hasSetValue = !!setValue;
  const propsRef = _GF35MDH7cjs.useLiveRef.call(void 0, {
    value,
    setValue
  });
...
function useStore(createStore2, props) {
  ...
  _GF35MDH7cjs.useSafeLayoutEffect.call(void 0, () => init(store), [store]);
  const useState2 = React.useCallback((keyOrSelector) => useStoreState(store, keyOrSelector), [store]);
  return [React.useMemo(() => ({
    ...store,
    useState: useState2
  }), [store, useState2]), _GF35MDH7cjs.useEvent.call(void 0, () => {
