...
function getFlipMiddleware(props) {
  ...
  _GF35MDH7cjs.invariant.call(void 0, !fallbackPlacements || fallbackPlacements.every(isValidPlacement), process.env.NODE_ENV !== "production" && "`flip` expects a spaced-delimited list of placements");
  return flip2({
...
var usePopover = _GF35MDH7cjs.createHook.call(void 0, function usePopover2({ store, modal = false, portal = modal, preserveTabOrder = true, autoFocusOnShow = true, wrapperProps, fixed = false, flip: flip3 = true, shift: shift3 = 0, slide = true, overlap = false, sameWidth = false, fitViewport = false, gutter, arrowPadding = 4, overflowPadding = 8, getAnchorRect, updatePosition, ...props }) {
  var _a, _b, _c, _d;
  const context = _KAU3JWAXcjs.usePopoverProviderContext.call(void 0, );
  store = store || context;
  _GF35MDH7cjs.invariant.call(void 0, store, process.env.NODE_ENV !== "production" && "Popover must receive a `store` prop or be wrapped in a PopoverProvider component.");
  const arrowElement = _P5CWMRCEcjs.useStoreState.call(void 0, store, "arrowElement");
  const anchorElement = _P5CWMRCEcjs.useStoreState.call(void 0, store, "anchorElement");
  const disclosureElement = _P5CWMRCEcjs.useStoreState.call(void 0, store, "disclosureElement");
  const popoverElement = _P5CWMRCEcjs.useStoreState.call(void 0, store, "popoverElement");
  const contentElement = _P5CWMRCEcjs.useStoreState.call(void 0, store, "contentElement");
  const placement = _P5CWMRCEcjs.useStoreState.call(void 0, store, "placement");
  const mounted = _P5CWMRCEcjs.useStoreState.call(void 0, store, "mounted");
  const rendered = _P5CWMRCEcjs.useStoreState.call(void 0, store, "rendered");
  ...
  const getAnchorRectProp = _GF35MDH7cjs.useEvent.call(void 0, getAnchorRect);
  const updatePositionProp = _GF35MDH7cjs.useEvent.call(void 0, updatePosition);
  ...
  props = _GF35MDH7cjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
    ...wrapperProps,
    style: {
      position,
      top: 0,
  ...
  props = _GF35MDH7cjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _KAU3JWAXcjs.PopoverScopedContextProvider, {
    value: store,
    children: element
  }), [store]);
  props = {
  ...
  props = _TQJSPK6Rcjs.useDialog.call(void 0, {
    store,
    modal,
    portal,
    preserveTabOrder,
...
var Popover = _TQJSPK6Rcjs.createDialogComponent.call(void 0, _GF35MDH7cjs.forwardRef.call(void 0, function Popover2(props) {
  const htmlProps = usePopover(props);
  return _GF35MDH7cjs.createElement.call(void 0, TagName, htmlProps);
}), _KAU3JWAXcjs.usePopoverProviderContext);

// ../ariakit-components/dist/popover/popover-store.js
function createPopoverStore({ popover: otherPopover, ...props } = {}) {
  const store = _P5CWMRCEcjs.mergeStore.call(void 0, props.store, _P5CWMRCEcjs.omit.call(void 0, otherPopover, [
    "arrowElement",
    "anchorElement",
    "contentElement",
    "popoverElement",
  ...
  const dialog = _TQJSPK6Rcjs.createDialogStore.call(void 0, {
    ...props,
    store
  });
  const placement = _GF35MDH7cjs.defaultValue.call(void 0, props.placement, syncState == null ? void 0 : syncState.placement, "bottom");
  const popover = _P5CWMRCEcjs.createStore.call(void 0, {
    ...dialog.getState(),
    placement,
    currentPlacement: placement,
    anchorElement: _GF35MDH7cjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.anchorElement, null),
    popoverElement: _GF35MDH7cjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.popoverElement, null),
    arrowElement: _GF35MDH7cjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.arrowElement, null),
...
function usePopoverStoreProps(store, update, props) {
  _GF35MDH7cjs.useUpdateEffect.call(void 0, update, [props.popover]);
  _P5CWMRCEcjs.useStoreProps.call(void 0, store, props, "placement");
  return _TQJSPK6Rcjs.useDialogStoreProps.call(void 0, store, update, props);
}
function usePopoverStore(props = {}) {
  const [store, update] = _P5CWMRCEcjs.useStore.call(void 0, createPopoverStore, props);
