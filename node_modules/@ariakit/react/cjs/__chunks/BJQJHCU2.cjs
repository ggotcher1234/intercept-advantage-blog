...
function useDisableEvent(onEvent, disabled) {
  return _GF35MDH7cjs.useEvent.call(void 0, (event) => {
...
function onGlobalMouseDown(event) {
  ...
  if (_GF35MDH7cjs.isElement.call(void 0, target) && !target.hasAttribute("data-focus-visible")) isKeyboardModality = false;
}
...
var useFocusable = _GF35MDH7cjs.createHook.call(void 0, function useFocusable2({ focusable = true, accessibleWhenDisabled, autoFocus, onFocusVisible, ...props }) {
  const ref = _react.useRef.call(void 0, null);
  const [parentAccessibleWhenDisabled, metadataProps] = _GF35MDH7cjs.useMetadataProps.call(void 0, props, accessibleWhenDisabledSymbol, accessibleWhenDisabled);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    _GF35MDH7cjs.addGlobalEventListener.call(void 0, "mousedown", onGlobalMouseDown, true);
    _GF35MDH7cjs.addGlobalEventListener.call(void 0, "keydown", onGlobalKeyDown, true);
    hasInstalledGlobalEventListeners = true;
  }, [focusable]);
  const disabled = focusable && _GF35MDH7cjs.disabledFromProps.call(void 0, props);
  ...
  const cleanupFocusVisible = _GF35MDH7cjs.useEvent.call(void 0, (element) => {
    var _a;
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const observer = new IntersectionObserver(() => {
      if (!_GF35MDH7cjs.isFocusable.call(void 0, element)) {
        focusVisibleRef.current = false;
  ...
  const handleFocusVisible = (event, currentTarget) => {
    ...
    if (isNativeSubmitControl(element)) {
      ...
      if (typeof IntersectionObserver !== "undefined") {
        const observer = new IntersectionObserver(() => {
          if (_GF35MDH7cjs.isFocusable.call(void 0, element)) return;
  ...
  const onKeyDownCapture = _GF35MDH7cjs.useEvent.call(void 0, (event) => {
    ...
    _GF35MDH7cjs.queueBeforeEvent.call(void 0, element, "focusout", applyFocusVisible);
  });
  const onFocusCaptureProp = props.onFocusCapture;
  const onFocusCapture = _GF35MDH7cjs.useEvent.call(void 0, (event) => {
    onFocusCaptureProp == null ? void 0 : onFocusCaptureProp(event);
    if (event.defaultPrevented) return;
    if (!focusable) return;
    if (!_GF35MDH7cjs.isSelfTarget.call(void 0, event)) {
      setFocusVisible(false);
      return;
    }
    const element = event.currentTarget;
    const applyFocusVisible = () => handleFocusVisible(event, element);
    if (isKeyboardModality || isAlwaysFocusVisible(event.target)) _GF35MDH7cjs.queueBeforeEvent.call(void 0, event.target, "focusout", applyFocusVisible);
  ...
  const onBlur = _GF35MDH7cjs.useEvent.call(void 0, (event) => {
    ...
    if (!focusable) return;
    if (!_GF35MDH7cjs.isFocusEventOutside.call(void 0, event)) return;
    cleanupFocusVisible(event.currentTarget);
    setFocusVisible(false);
  });
  const autoFocusOnShow = _react.useContext.call(void 0, FocusableContext);
  const autoFocusRef = _GF35MDH7cjs.useEvent.call(void 0, (element) => {
    if (!focusable) return;
    if (!autoFocus) return;
    if (!element) return;
  ...
  if (isSafariBrowser) _react.useEffect.call(void 0, () => {
    ...
    setSafariTabIndex(_GF35MDH7cjs.isButton.call(void 0, element) || isNativeCheckboxOrRadio);
  }, [focusable]);
  ...
  props = {
    ...
    ...props,
    ...metadataProps,
    ref: _GF35MDH7cjs.useMergeRefs.call(void 0, ref, autoFocusRef, props.ref),
    style,
...
var Focusable = _GF35MDH7cjs.forwardRef.call(void 0, function Focusable2(props) {
