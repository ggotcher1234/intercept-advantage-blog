...
import { disabledFromProps, getActiveElement, getScrollingElement, getTextboxSelection, getTextboxValue, isButton, isPortalEvent, isSafari, isSelfTarget, isTextField, isTextbox, removeUndefinedValues } from "@ariakit/utils";
...
const useCompositeItem = createHook(function useCompositeItem({ store, rowId: rowIdProp, preventScrollOnKeyDown = false, moveOnKeyPress = true, tabbable = false, getItem: getItemProp, "aria-setsize": ariaSetSizeProp, "aria-posinset": ariaPosInSetProp, ...props }) {
	...
	const onFocus = useEvent((event) => {
		...
		const redirectFocusToBaseElement = (currentTarget, relatedTarget, baseElement) => {
			if (isSafari() && currentTarget.hasAttribute("data-autofocus")) currentTarget.scrollIntoView({
				block: "nearest",
				inline: "nearest"
			});
			hasFocusedComposite.current = true;
			if (relatedTarget === baseElement || isItem(store, relatedTarget)) focusSilently(baseElement);
