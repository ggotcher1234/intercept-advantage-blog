import { n as CollectionItemOptions } from "../collection-item-offscreen-7he3SC47.js";
import { n as CompositeItemOptions$1 } from "../composite-item-CvSLGZAk.js";
import { Props } from "@ariakit/react-utils";
import { ElementType } from "react";
//#region src/composite/composite-item-offscreen.d.ts
declare const TagName = "button";
type TagName = typeof TagName;
declare function useCompositeItemOffscreen<T extends ElementType, P extends CompositeItemProps<T>>({ store, offscreenMode, disabled: disabledProp, value, ...props }: P): {
  id: string | undefined;
  active: boolean;
...
declare const CompositeItem: ({ offscreenMode, offscreenRoot, ...props }: CompositeItemProps) => import("react").JSX.Element;
