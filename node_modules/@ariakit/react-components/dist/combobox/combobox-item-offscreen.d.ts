...
declare function useComboboxItemOffscreen<T extends ElementType, P extends ComboboxItemProps<T>>({ store, value, ...props }: P): {
  id: string | undefined;
  active: boolean;
...
declare const ComboboxItem: ({ offscreenMode, offscreenRoot, ...props }: ComboboxItemProps) => import("react").JSX.Element;
